...
# 可视化随机森林的决策边界
plot_decision_regions(X_test.values, y_test.values.astype(np.int_), clf=rf, legend=2)

# plot_decision_regions(X_test.values, y_test.astype(np.int_), clf=rf, legend=2)
